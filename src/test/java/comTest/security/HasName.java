...
//		if (exhibit instanceof HasName)
//			return id == ((HasName) exhibit).id;
//		else
//			throw new ExceptionCoding("invalid class " + exhibit.getClass().getCanonicalName());
//		return false;
//	}
